...
if __name__ == "__main__":
    ...
    # ✅ SAUVEGARDER MODÈLE
    save_model(pop, path="figs/model_abl_2_crop_10.pt")
    ...
    visualize_best_model(
        ...
        save_dir="figs/viz_abl_2_crop_10",
        n_examples=8
    )
    ...
    import shutil
    shutil.make_archive("figs/viz_abl_2_crop_10", 'zip', "figs/viz_abl_2_crop_10")
    ...
    try:
        ...
        # Modèle
        shutil.copy("figs/model_abl_2_crop_10.pt", f"{drive_path}model_abl_2_crop_10.pt")

        # Visualisations ZIP
        shutil.copy("figs/viz_abl_2_crop_10.zip", f"{drive_path}viz_abl_2_crop_10.zip")

        files.download("figs/abl_2_crop_10.csv")
        files.download("figs/abl_2_crop_10.json")
        files.download("figs/viz_abl_2_crop_10.zip")
