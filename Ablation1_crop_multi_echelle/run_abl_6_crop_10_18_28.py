...
if __name__ == "__main__":
    print("=== RUN 6 : Avec CROP, patches (10,10)+(18,18)+(28,28) ===\n")
    ...
    acc, _, _, _ = run_experiment(
        ...
        name='crop_patch10_18_28', num_classes=NUM_CLASSES, epochs=EPOCHS,
        lr=BASE['lr'], num_cells=BASE['num_cells'],
        patch_sizes=[(10, 10), (18, 18), (28, 28)],  # ← BASELINE
        theta_init=BASE['theta_init'], device=DEVICE,
        K=BASE['K'], use_intensity=BASE['use_intensity']
    )

    print(f"\n✅ Avec CROP, (10,10)+(18,18)+(28,28) → {acc:.4f}")
    result = [{"run": 6, "crop": True, "patches": "[(10,10),(18,18),(28,28)]", "acc": acc}]

    pd.DataFrame(result).to_csv("figs/abl_6_crop_10_18_28.csv", index=False)
    with open("figs/abl_6_crop_10_18_28.json", "w") as f:
    ...
    try:
        ...
        shutil.copy("figs/abl_6_crop_10_18_28.csv",  f"{drive_path}abl_6_crop_10_18_28.csv")
        shutil.copy("figs/abl_6_crop_10_18_28.json", f"{drive_path}abl_6_crop_10_18_28.json")
        files.download("figs/abl_6_crop_10_18_28.csv")
        files.download("figs/abl_6_crop_10_18_28.json")
