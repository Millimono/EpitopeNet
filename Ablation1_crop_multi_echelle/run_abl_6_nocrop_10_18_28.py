...
SEED, EPOCHS = 42, 15
BASE = {'num_cells': 6400, 'theta_init': 0.5, 'lr': 0.1, 'K': 1, 'use_intensity': True}  # 6400 = 3 échelles
...
if __name__ == "__main__":
    ...
    acc, _, _, _ = run_experiment(
        ...
        name='nocrop_patch10_18_28', num_classes=NUM_CLASSES, epochs=EPOCHS,
    ...
    print(f"\n✅ NOCROP, (10,10)+(18,18)+(28,28) → {acc:.4f}")
    result = [{"run": 6, "crop": False, "patches": "[(10,10),(18,18),(28,28)]", "acc": acc}]

    pd.DataFrame(result).to_csv("figs/abl_6_nocrop_10_18_28.csv", index=False)
    with open("figs/abl_6_nocrop_10_18_28.json", "w") as f:
    ...
    try:
        ...
        shutil.copy("figs/abl_6_nocrop_10_18_28.csv",  f"{drive_path}abl_6_nocrop_10_18_28.csv")
        shutil.copy("figs/abl_6_nocrop_10_18_28.json", f"{drive_path}abl_6_nocrop_10_18_28.json")
