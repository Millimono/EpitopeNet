...
if __name__ == "__main__":
    print("=== RUN 6 : NOCROP, patches (10,10)+(18,18)+(28,28) ===\n")
    ...
    acc, pop, _, _ = run_experiment(
        ...
        name='nocrop_patch10_18_28_lr0001',
    ...
    print(f"\n✅ NOCROP, (10,10)+(18,18)+(28,28), lr=0.001 → {acc:.4f}")

    result = [{"run": 6, "crop": False, "patches": "[(10,10),(18,18),(28,28)]",
               "lr": 0.001, "intensity": False, "acc": acc}]

    drive_path = "/content/drive/MyDrive/ablation_results/"
    os.makedirs(drive_path, exist_ok=True)

    pd.DataFrame(result).to_csv("figs/run6_nocrop_10_18_28.csv", index=False)
    with open("figs/run6_nocrop_10_18_28.json", "w") as f:
        json.dump(result, f, indent=2)

    save_model(pop, path="figs/model_run6_nocrop_10_18_28.pt")

    shutil.copy("figs/run6_nocrop_10_18_28.csv",        f"{drive_path}run6_nocrop_10_18_28.csv")
    shutil.copy("figs/run6_nocrop_10_18_28.json",       f"{drive_path}run6_nocrop_10_18_28.json")
    shutil.copy("figs/model_run6_nocrop_10_18_28.pt",   f"{drive_path}model_run6_nocrop_10_18_28.pt")
